...
/* package */ final class XingFrame {
  ...
  public static XingFrame parse(MpegAudioUtil.Header mpegAudioHeader, ParsableByteArray frame) {
    ...
    return new XingFrame(
        mpegAudioHeader, frameCount, dataSize, tableOfContents, hasReplayGain, replayGainPeak,
            replayGainField1Name, replayGainField1Originator, replayGainField1Value,
            replayGainField2Name, replayGainField2Originator, replayGainField2Value,
