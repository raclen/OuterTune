...
public interface ShuffleOrder {
   ...
   *
   * <p>The default implementation uses {@link #cloneAndClear} and {@link
   * #cloneAndInsert(int, int)} to replace all elements in the shuffle order. Custom implementations
   * can override this method if access to the {@code startIndex} is desired.
   *
   * @param insertionCount The number of elements.
   * @param startIndex The index playback will start from after replacement, or
   *                   {@link C#INDEX_UNSET} if the new list is empty or the index is unknown.
   *
